...
function render(){applyCampaignLifecycle();updateHeader();nav.querySelectorAll('[data-view]').forEach(b=>b.classList.toggle('active',b.dataset.view===currentView));(views[currentView]||views.status)();requestAnimationFrame(()=>applySceneLayout(root))}
