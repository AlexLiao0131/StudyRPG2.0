...
function migrateHero(raw={},fallback={}){
  ...
  return {
    ...
    jobPassive:String(raw.jobPassive||''),skillUsage:object(raw.skillUsage),skillUsageByDate:object(raw.skillUsageByDate),jobCandidateHistory:array(raw.jobCandidateHistory),
    pendingGoldDebt:Math.max(0,Number(raw.pendingGoldDebt)||0),lastStatGains:object(raw.lastStatGains),equipment:object(raw.equipment||fallback.equipment)
  };
}
