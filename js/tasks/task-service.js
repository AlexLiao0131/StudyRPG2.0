...
export function recordsForTaskToday(id){const day=localDateString();return(getGame().taskRecords||[]).filter(r=>String(r.taskId)===String(id)&&r.date===day&&r.status==='completed'&&!r.duplicateRewardReversed)}
